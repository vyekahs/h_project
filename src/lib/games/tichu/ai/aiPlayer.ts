...
export class AiPlayer {
	...
	makeExchangeDecision(hand: Card[], partnerDeclaredTichu: boolean = false, selfDeclaredTichu: boolean = false): ExchangeCards {
		return selectExchangeCards(hand, this.seat, this.weights, this.behavior, partnerDeclaredTichu, selfDeclaredTichu);
	}
